...
local function Local(o)
	...
	if o == "TukuiConfigUIgeneralbuffsize" then o = TukuiL.option_general_buffsize end
	if o == "TukuiConfigUIgeneralrowbuffs" then o = TukuiL.option_general_rowbuffs end
	if o == "TukuiConfigUIgeneralactionbarbuttonsize" then o = TukuiL.option_general_actionbarbuttonsize end
	if o == "TukuiConfigUIgeneralpetbarbuttonsize" then o = TukuiL.option_general_petbarbuttonsize end
	...
	if o == "TukuiConfigUImaploctaionhover" then o = TukuiL.option_map_loctaionhover end
	...
	if o == "TukuiConfigUIchatchatbackground" then o = TukuiL.option_chat_chatbackground end
	
	--Broker
	if o == "TukuiConfigUIbroker_datatext" then o = TukuiL.option_broker_datatext end
	if o == "TukuiConfigUIbroker_datatextSkada" then o = TukuiL.option_broker_datatext_Skada end
	...
	if o == "TukuiConfigUIbroker_datatextclsaver" then o = TukuiL.option_broker_datatext_clsaver end
